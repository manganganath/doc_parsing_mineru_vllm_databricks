...
- **vLLM_RT**: Use for demos, prototyping, or interactive applications that need sub-second per-page latency. Pause the job when not in use to stop GPU billing.
